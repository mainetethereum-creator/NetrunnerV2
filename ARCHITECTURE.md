...
| Input | window keydown/keyup (WASD/arrows, Shift, E), tap-to-move raycast, `setStick` | + Space fire, MASTER keys | 1–4 skills in `CombatDriver`, I inventory in `GameHud`, H hide HUD in `BaseApp` |
