...
export const PROP_ASSETS=[
 ...
 {id:'burning-drum',name:'Бочка · огонь окраины',category:'Детали',description:'Ржавая бочка с углями, огнём и тёплым светом'},
...
export function createPropLibrary(anisotropy=4,onTextureReady?:()=>void,gardenSigns=false,referenceLibrary?:ReferenceBuildingLibrary){
 const references=referenceLibrary??createReferenceBuildingLibrary(anisotropy,undefined,undefined,undefined,gardenSigns);
 ...
 if(id==='blue-drum'||id==='burning-drum')drum(0,0,1);
