...
// Temporary pre-launch building mode. Encounter data stays intact so mobs can
// be restored later without rebuilding the map or editor.
export const EXPEDITION_ENEMIES_ENABLED=false;
...
export const ITEMS:Record<LootKind,{name:string;rarity:string}>={scrap:{name:'Scrap Metal',rarity:'COMMON'},electronics:{name:'Electronics',rarity:'COMMON'},batteries:{name:'Batteries',rarity:'UNCOMMON'},weapon_parts:{name:'Weapon Parts',rarity:'UNCOMMON'},upgrade_module:{name:'Upgrade Module',rarity:'RARE'},prototype:{name:'Prototype',rarity:'EPIC'}};
...
export const POIS:POI[]=[
  {id:'fountain',name:'Old Fountain',kind:'camp',x:49,z:27,lootTable:'salvage'},
  {id:'fuel',name:'Last Fuel Station',kind:'station',x:25,z:20,lootTable:'salvage'},
  {id:'convoy',name:'Crashed Convoy',kind:'convoy',x:43,z:38,lootTable:'salvage'},
  {id:'camp',name:'Evacuation Camp',kind:'camp',x:53,z:11,lootTable:'salvage'},
  {id:'shelter',name:'Sealed Archive',kind:'bunker',x:65,z:57,lootTable:'technical',access:'keycard'},
  {id:'warehouse',name:'Warehouse 07',kind:'warehouse',x:87,z:23,lootTable:'technical'},
  {id:'power',name:'Relay Station',kind:'power',x:103,z:50,lootTable:'technical'},
  {id:'core',name:'Prototype Vault',kind:'bunker',x:122,z:27,lootTable:'elite'},
  {id:'catwalk',name:'Service Catwalk',kind:'camp',x:107,z:58,lootTable:'technical'},
];
export const EXTRACTIONS=[{id:'breach',name:'Breach / Return to Base',x:7,z:36},{id:'lift',name:'Freight Elevator',x:133,z:51}];
