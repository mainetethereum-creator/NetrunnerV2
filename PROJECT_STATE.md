...
- Assets: the three zips (≈ 66 MB) → runtime artwork `public/ui` ≈ 1.2 MB (three hub backdrops ≈ 880 KB, one loads per device) (WebP, cropped to art without baked text) + references and layout grids in `docs/ui-kits` ≈ 450 KB.
